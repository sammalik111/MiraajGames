      ...
      <main className="max-w-7xl mx-auto px-4 py-10 sm:px-6 lg:px-8">
        <section className="grid gap-10 md:grid-cols-[1.4fr_1fr] items-center">
          <div className="space-y-6">
            <span className="inline-flex items-center rounded-full bg-violet-500/15 px-4 py-2 text-sm font-semibold text-violet-100 ring-1 ring-violet-400/20">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a
                href="/auth/signin"
                className="inline-flex items-center justify-center rounded-full border border-slate-700 bg-slate-900/80 px-6 py-3 text-sm font-semibold text-slate-100 transition hover:border-slate-500"
              >
                Sign In
              </a>
            </div>
          ...
          <div className="rounded-[2rem] border border-slate-800 bg-slate-900/80 p-8 shadow-2xl shadow-black/40 backdrop-blur-xl">
            <div className="space-y-6">
              <div className="flex items-center justify-between gap-4">
                <div>
                  <p className="text-sm uppercase tracking-[0.24em] text-slate-400">Featured game</p>
              ...
              <div className="grid gap-4 rounded-3xl border border-slate-800 bg-gradient-to-br from-violet-950/90 to-slate-900/80 p-6 text-slate-300">
                <div className="rounded-3xl bg-slate-950/90 p-5 shadow-inner shadow-slate-900/30">
                  <p className="text-sm text-slate-500">Platformer with classic vibes and responsive controls.</p>
                </div>
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="rounded-3xl bg-slate-950/90 p-4 text-sm text-slate-300">Explore dynamic levels</div>
                  <div className="rounded-3xl bg-slate-950/90 p-4 text-sm text-slate-300">Save favorites automatically</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="games" className="mt-16">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="max-w-2xl text-slate-400">Tap into a growing collection of demo experiences, from strategy to arcade and classic sports.</p>
            </div>
